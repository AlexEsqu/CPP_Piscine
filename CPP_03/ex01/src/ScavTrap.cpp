...
ScavTrap::~ScavTrap()
{
	std::cout << RED << FAINT << "ScavTrap destructor called" << STOP_COLOR << STOP_STYLE << std::endl;
}
...
ScavTrap::ScavTrap( const ScavTrap& original )
	: ClapTrap(original)
{
	std::cout << GREEN << FAINT << "ScavTrap copy constructor called" << STOP_COLOR << STOP_STYLE << std::endl;
...
{
	std::cout << GREEN << FAINT << "ScavTrap copy assignement called" << STOP_COLOR << STOP_STYLE << std::endl;
