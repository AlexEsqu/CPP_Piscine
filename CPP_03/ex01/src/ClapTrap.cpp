...
ClapTrap::~ClapTrap()
{
	std::cout << RED << FAINT << "ClapTrap destructor called" << STOP_COLOR << STOP_STYLE << std::endl;
}
...
{
	std::cout << GREEN << FAINT << "ClapTrap copy constructor called" << STOP_COLOR << STOP_STYLE << std::endl;
}
